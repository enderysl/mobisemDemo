...
import com.enderyasli.mobisemdemo.util.GridSpacingItemDecoration;
import com.enderyasli.mobisemdemo.util.Measure;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void observeLiveData() {
        ...
        viewModel.data.observe(this, gameResponse -> {
            ...
            if (adapter == null)
                ...
                /* added not to load extra pages on first load */
    ...
    private void initRecyclerView(ArrayList<GameDetail> gameDetail) {
        ...
        spacingDecoration = new GridSpacingItemDecoration(2, Measure.pxToDp(10, this), true);
        binding.gameRecyclerView.addItemDecoration(spacingDecoration);
        binding.gameRecyclerView.setItemAnimator(null);
        binding.gameRecyclerView.setLayoutManager(new GridLayoutManager(this, 2));
        gridLayoutManager = ((GridLayoutManager) binding.gameRecyclerView.getLayoutManager());
